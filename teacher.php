    ...
    <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./404.php">Logout</a>
          </li>
        </ul>
      </div>
    </nav>
      ...
      <div class="row">
        <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
          <ul class="nav nav-pills flex-column">
            <li class="nav-item">
              <a class="nav-link active" href="./teacher.php">Current Files <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
          ...
          <table class="table table-hover table-condensed table-border">
      		...
      		if (count($notes)) {
      			foreach ($notes as $key => $note) {
                    ...
                    <a href='./file.php?action=delete&file=".$note["download_url"]."'><span class='fa fa-trash fa-lg pull-right text-danger'></span></a>
  						</tr>";
      			}
      		}
